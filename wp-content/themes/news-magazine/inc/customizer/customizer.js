jQuery('document').ready(function(){
  ...
  if(true){  
    ...
    '<div class="WDWT_IS_PRO_banner" style="font-size:16px; margin-top:8px; text-align:left;">'
      +'<a href="'+ WDWT.homepage +'/wordpress-themes/news-magazine.html" target="_blank" style="color:red; text-decoration:none; display:block;">'
    ...
    jQuery("body ").on( "click",'[id^=accordion-panel-news_magazine]', function() {
