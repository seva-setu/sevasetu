	...
	*/
	...
	function widget($args, $instance) {
		if (!empty($instance)) {
			...
			echo '<div class="fullwindow contentwide '.$custom_class.'" '.($height > 0 ? 'style="height: '.$height.'px;"' : '').' id="'.$id.'"><div class="fullwindow-internal cf '.$oddeven.'"><div class="constrained"><div class="ign-content-fullalt" style="height: '.$height.'px;"><h3>'.$title.'</h3>';
