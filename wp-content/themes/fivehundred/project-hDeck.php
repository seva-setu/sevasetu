			...
			<div id="ign-hDeck-right">
				<div class="internal">
					<div class="ign-product-goal" style="clear: both;">
						<div class="ign-goal"><?php _e('Goal', 'fivehundred'); ?></div> <strong><?php echo $hDeck->currency_code; ?><?php echo apply_filters('id_project_goal', $hDeck->goal, $id); ?> </strong>
					</div>
					...
					<div class="ign-progress-wrapper" style="clear: both;">
						<div class="ign-progress-percentage">
										<?php echo apply_filters('id_percentage_raised', $hDeck->percentage, $hDeck->total, $id, $hDeck->goal); ?>%
						</div> <!-- end progress-percentage -->
						<div style="width: <?php echo apply_filters('id_percentage_raised', $hDeck->percentage, $hDeck->total, $id, $hDeck->goal); ?>%" class="ign-progress-bar">
						
						</div><!-- end progress bar -->
					</div>
					
					<div class="ign-progress-raised">
						<strong><?php echo $hDeck->currency_code; ?><?php echo apply_filters('id_funds_raised', $hDeck->total, $id); ?></strong>
						<div class="ign-raised">
							<?php _e('Raised', 'fivehundred'); ?>
						</div>
					</div>
					<div class="ign-product-supporters" style="clear: both;">
						<strong><?php echo apply_filters('id_number_pledges', $hDeck->pledges, $id); ?></strong>
