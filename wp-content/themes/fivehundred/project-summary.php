...
<div class="ign-project-summary <?php echo (!empty($summary->successful) ? 'success' : ''); ?> <?php echo 'post-'.$id; ?>">
	...
	<div class="ign-summary-container">
		...
		<div class="ign-progress-wrapper">
			<div class="ign-progress-raised"><?php echo apply_filters('id_funds_raised', $summary->total, $id); ?> <?php _e('RAISED', 'fivehundred'); ?></div>
			<div class="ign-progress-bar" style="width: <?php echo apply_filters('id_percentage_raised', $summary->percentage, $summary->total, $id, $summary->goal).'%'; ?>"></div>
			<div class="ign-progress-percentage"><?php echo apply_filters('id_percentage_raised', $summary->percentage, $summary->total, $id, $summary->goal).'%'; ?></div>
		</div>
