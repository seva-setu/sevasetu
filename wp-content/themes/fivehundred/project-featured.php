		...
		<div class="featured-border">
			...
			<div class="featured-inner">
				<div class="featured-item">
					<strong><?php _e('Goal',  'fivehundred'); ?>: </strong><span><?php echo apply_filters('id_project_goal', $summary->goal, $id); ?></span>
				</div>
				<div class="featured-item">
					<strong><?php _e('Raised',  'fivehundred'); ?>: </strong><span><?php echo apply_filters('id_funds_raised', $summary->total, $id); ?></span>
				</div>
				<div class="featured-item">
					<strong><?php _e('Supporters',  'fivehundred'); ?>: </strong><span><?php apply_filters('id_number_pledges', $pledges_count, $featured_post); ?></span>
				</div>
				<div class="featured-item">
				...
				<div class="featured-item">
					<div class="ign-progress-wrapper" style="clear: both;">
						...
						<div style="width: <?php echo apply_filters('id_percentage_raised', $summary->percentage, $summary->total, $id, $summary->goal); ?>%" class="ign-progress-bar">
