<div class="ignitiondeck id-creatorprofile">
	<div class="id-creator-avatar"><img src="<?php echo (isset($profile['logo']) ? $profile['logo'] : ''); ?>" title="<?php echo (isset($profile['name']) ? $profile['name'] : ''); ?>"/></div>
	<div class="id-creator-content">
		<div class="id-creator-name"><?php echo (isset($profile['name']) ? $profile['name'] : ''); ?></div>
