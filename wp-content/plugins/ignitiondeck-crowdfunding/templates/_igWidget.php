		...
		<div class="id-product-infobox">
			<div class="product-wrapper">
				...
				<?php if (!$custom || ($custom && isset($attrs['project_goal']))) { ?>
					<div class="id-product-funding"><?php echo $tr_Pledged_Of; ?> <?php echo apply_filters('id_project_goal', $the_deck->project->goal, $the_deck->post_id) ?> <?php echo $tr_Goal; ?></div>
				<?php } ?>
