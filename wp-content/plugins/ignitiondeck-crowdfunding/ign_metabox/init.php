					...
					if ($meta_no_levels > 0 || $meta_no_levels != "") {
						...
						for ($i=2 ; $i <= $meta_no_levels ; $i++) {
							...
							echo '<div'.(($i == 0) ? '' : ' level="'.($i).'"').' class="projectmeta-levelbox">'.
									...
									'<div class="ign_projectmeta_reward_desc"><label style="font-weight: bold">'.__('Level Long Descriptions', 'ignitiondeck').' </label><textarea name="levels['.$i.'][description]" id="ign_level'.$i.'desc" cols="60" rows="4" style="width:97%">'.$meta_desc.'</textarea></div>'.
								'<div></div>';
								echo '</div>';
						}
		...
		jQuery(document).ready(function(e) {
			jQuery('span[addlevel]').click(function () {
				...
				jQuery('div[levels]').append('<div level="'+element_number+'" class="projectmeta-levelbox">' +
									...
									'<div class="ign_projectmeta_reward_desc"><label style="font-weight: bold"><?php _e('Level Long Description', 'ignitiondeck'); ?> </label><textarea name="levels['+element_number+'][description]" id="ign_level'+element_number+'desc" cols="60" rows="4" style="width:97%"></textarea></div>' +
